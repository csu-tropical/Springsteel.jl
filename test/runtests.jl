...
@testset "Springsteel.jl" begin
    ...
    TEST_GROUP in ("all", "reference_state") && include("reference_state.jl")
    ...
    TEST_GROUP in ("all", "cell_counts") && include("cell_counts.jl")
    ...
    TEST_GROUP in ("all", "positivity")       && include("positivity.jl")
end
